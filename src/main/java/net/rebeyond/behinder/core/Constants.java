...
public class Constants {
    ...
    public static String UPDATE_URL="https://github.com/dbgee/bingxie/updateinfo.json";
    public static String DOWNLOAD_URL="https://github.com/dbgee/bingxie/release";
