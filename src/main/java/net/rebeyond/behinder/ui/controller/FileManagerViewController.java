...
public class FileManagerViewController {
    ...
    private Logger logger= LoggerFactory.getLogger(FileManagerViewController.class);
...
//
//            return (StringProperty)((List)data).get(0);
//        });
//        ((TableColumn)tcs.get(1)).setCellValueFactory((data) -> {
//            return (StringProperty)((List)data).get(1);
//        });
...
//            return (StringProperty)((List)data).get(2);
//        });
//        ((TableColumn)tcs.get(3)).setCellValueFactory((data) -> {
//            return (StringProperty)((List)data).get(4);
//        });

//        ObservableList<TableColumn<List<StringProperty>, ?>> tcs = this.fileListTableView.getColumns();
//        ((TableColumn)tcs.get(0)).setCellValueFactory(data -> (StringProperty)((List<StringProperty>)data.getValue()).get(0));
//        ((TableColumn)tcs.get(1)).setCellValueFactory(data -> (StringProperty)((List<StringProperty>)data.getValue()).get(1));
//        ((TableColumn)tcs.get(1)).setComparator((o1, o2) -> Long.compare(Long.parseLong(o1), Long.parseLong(o2)));
//        ((TableColumn)tcs.get(2)).setCellValueFactory(data -> (StringProperty)((List<StringProperty>)data.getValue()).get(2));
//        ((TableColumn)tcs.get(3)).setCellValueFactory(data -> (StringProperty)((List<StringProperty>)data.getValue()).get(4));


//        [StringProperty [value: teamviewer原版], StringProperty [value: 0], StringProperty [value: 2021-04-01 11:32:05], StringProperty [value: directory], StringProperty [value: R/W/-]]
//        [StringProperty [value: 1.cer], StringProperty [value: 6417], StringProperty [value: 2021-05-15 17:07:54], StringProperty [value: file], StringProperty [value: R/W/-]]
        ObservableList<TableColumn<List<StringProperty>, ?>> tcs = this.fileListTableView.getColumns();
//        名称
        tcs.get(0).setCellValueFactory((data)->{
            logger.debug("data.getValue:{}",data.getValue());
            return (ObservableValue)data.getValue().get(0);
        });
//        大小
        tcs.get(1).setCellValueFactory((data)->{
            return (ObservableValue) data.getValue().get(1);
        });

        tcs.get(1).setComparator((o1,o2)->{
            return Long.compare(Long.parseLong((String) o1),Long.parseLong((String) o2));
        });
//        修改时间
        tcs.get(2).setCellValueFactory((data)->{
            return (ObservableValue)data.getValue().get(2);
        });
//        权限
        tcs.get(3).setCellValueFactory((data)->{
            return (ObservableValue)data.getValue().get(4);
        });
