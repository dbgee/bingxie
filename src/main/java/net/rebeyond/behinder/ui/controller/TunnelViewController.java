...
public class TunnelViewController {
    ...
    private void stopLocalWorkers(List<Thread> workList) {
    ...
    private void stopLocalAllWorkers(List<Thread> workList) {
        Iterator var2 = workList.iterator();
    ...
    private void createLocalSocks() {
        ...
        this.proxyTunnelWorker = new ProxyTunnelWorker("daemon", paramMap);
    ...
    class ProxyTunnelWorker implements Runnable {
        ...
        private ServerSocket serverSocket;
        private Map<String, List<Thread>> proxyTunnelWorkerListMap = new HashMap();

        public ProxyTunnelWorker(String threadType, Map<String, Object> paramMap) {
        ...
        private void shutDown() {
            ...
            while(var1.hasNext()) {
                ...
                List<Thread> workerList = (List)this.proxyTunnelWorkerListMap.get(socketHash);
                    ...
                    while(true) {
                        while(true) {
                            try {
                                ...
                                List<Thread> proxyTunnelWorkList = new ArrayList();
        ...
        private void stopSession(List<Thread> proxyTunnelWorkList) {
            Runnable runner = () -> {
                    ...
                    try {
                        ...
                        for(bytesRead = 0; bytesRead < socketArr.length(); ++bytesRead) {
                            ...
                            if (socketHash.startsWith("reverseportmap_socket") && !this.socketMetaList.containsKey(socketHash)) {
                                Map<String, Object> socketMeta = new HashMap();
