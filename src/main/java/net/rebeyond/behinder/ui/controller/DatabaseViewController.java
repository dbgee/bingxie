...
public class DatabaseViewController {
    ...
    private Logger logger= LoggerFactory.getLogger(DatabaseViewController.class);
        ...
        if (result.get(0).getClass().toString().equals("class org.json.JSONArray")) {
            ...
            for(int i = 0; i < fieldArray.length(); ++i) {
                ...
                col.setCellValueFactory((datax) -> {
                    return (StringProperty)((List)datax.getValue()).get(finalI);
                });
            }
